// Shared showcase footer — links to Bunlong's site + socials. Plain component
// (no client hooks), safe in both the client /demo gallery and the server /d page.
      ...
      <div style={{ display: "flex", gap: 10 }}>
        {LINKS.map(l => (
          <a key={l.label} className="sf-ico" href={l.href} target="_blank" rel="noopener noreferrer" title={l.label} aria-label={l.label}
            style={{ width: 30, height: 30, borderRadius: 8, display: "flex", alignItems: "center", justifyContent: "center", color: "#64748b", background: "#fff", border: "1px solid #e6e8ee", textDecoration: "none" }}>
            {l.icon}
          </a>
        ))}
      </div>
